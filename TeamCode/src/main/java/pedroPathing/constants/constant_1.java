...
public class constant_1 {
    ...
    public static final double SPIN_CHANGE = 0.05;
    public static final double SPIN_INITIAL_POSITION = 0.4;
    ...
    public static final double ARM_LEFT_POST_TERRACE_POSITION = 0.07;
